...
setwd("D:/MEGA/Publication 1/PILOT4 (2)/CPMG_16082018/")
library(readr)
UF_PILOT4_3_withexcl <- read_csv("CPMG_PILOT4_3_excl_final.csv")
...
#write.csv(file="CPMG_PILOT4_3_excl_new_20.csv", pearl)
...
sparrow$`5.995082927`<- NULL
#write.csv(file="CPMG_PILOT4_3_excl_new_20_MA.csv", sparrow)
...
#write.csv(file="CPMG_PILOT4_3_excl_new_20_MA_PQN0.csv", beckett)
...
#write.csv(file="CPMG_PILOT4_3_excl_new_20_MA_PQN0_knn.csv", cutler)
...
#write.csv(final, file="CPMG_PILOT4_3_excl_new_20_MA_PQN0_knn_GLOG.csv")
...
plotIndiv(pca.ENP, group = why, ind.names = FALSE,legend = T, title= 'PCA CPMG SPEAQ MA PQN GLOG')
plotLoadings(pca.ENP, comp = 1, ndisplay = 30, title = 'PCA CPMG SPEAQ MA PQN GLOG')
...
mitch=vip(ENP.plsda)
write.csv(mitch, file="CPMG_PILOT4_3_excl_new_20_MA_PQN0_knn_GLOG_VIPS.csv")
...
save.image("D:/MEGA/Publication 1/PILOT4 (2)/CPMG_16082018/CPMG_SPEAQ_P4.RData")