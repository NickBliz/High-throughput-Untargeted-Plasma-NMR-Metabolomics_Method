...
setwd("D:/MEGA/Publication 1/PILOT4 (2)/UF_16082018/")
library(readr)
UF_PILOT4_3_withexcl <- read_csv("D:/MEGA/Publication 1/PILOT4 (2)/UF_16082018/UF_PILOT4_3_excl_final.csv")
...
#write.csv(file="UF_PILOT4_3_excl_new_20.csv", pearl)
...
sparrow$`5.994513374`<- NULL
#write.csv(file="UF_PILOT4_3_excl_new_20_MA.csv", sparrow)
...
#write.csv(file="UF_PILOT4_3_excl_new_20_MA_PQN0.csv", beckett)
...
#write.csv(file="UF_PILOT4_3_excl_new_20_MA_PQN0_knn.csv", cutler)
...
#write.csv(final, file="UF_PILOT4_3_excl_new_20_MA_PQN0_knn_GLOG.csv")
...
plotIndiv(pca.ENP, group = why, ind.names = FALSE,legend = T, title= 'PCA UF SPEAQ MA PQN GLOG')
plotLoadings(pca.ENP, comp = 1, ndisplay = 30, title= 'PCA UF SPEAQ MA PQN GLOG')
...
predictions_uncorrected=as.matrix(mitch$class$mahalanobis.dist)
...
mitch=vip(ENP.plsda)
write.csv(mitch, file="UF_PILOT4_3_excl_new_20_MA_PQN0_knn_GLOG_vips.csv")
...
save.image("D:/MEGA/Publication 1/PILOT4 (2)/UF_16082018/UF_SPEAQ_P4.RData")