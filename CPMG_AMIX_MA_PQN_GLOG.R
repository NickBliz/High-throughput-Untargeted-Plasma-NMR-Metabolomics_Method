...
UF_PILOT4_3_new_25_PQN_min_noRSD0_3_GLOG <- read_csv("bucket_table_final_CPMG.csv")
...
#write.csv(file="bucket_table_cpmg_new_20.csv", pearl)
...
#write.csv(file="bucket_table_cpmg_new_20_MA.csv", sparrow)
...
cutler=beckett
#write.csv(file="bucket_table_cpmg_new_20_MA_PQN.csv", beckett)
...
#write.csv(final, file="bucket_table_cpmg_new_20_MA_PQN_GLOG.csv")
...
plotIndiv(pca.ENP, group = why, ind.names = FALSE,legend = T, title= 'PCA CPMG AMIX MA PQN GLOG')
plotLoadings(pca.ENP, comp = 1, ndisplay = 30, title= 'PCA CPMG AMIX MA PQN GLOG')
...
mitch=vip(ENP.plsda)
write.csv(mitch, file="CPMG_AMIX_MA_PQN_GLOG_VIPs.csv")
...
save.image("D:/MEGA/Publication 1/PILOT4 (2)/btp_final_3/CPMG_AMIX_final_models.RData")